...
export default function Home() {
  ...
  const [analysis, setAnalysis] = useState<ResumeLiteResultData | null>(null);
  ...
  const handleUpload = async (file: File) => {
    ...
    try {
      ...
      if (
        ...
        toast.info("💡 Tip: Check the README for setup instructions", {
          duration: 6000,
        });
      } else if (
          ...
          <div className="text-center space-y-8">
            ...
            <div className="mt-16 space-y-4">
              ...
              <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                Use this Instant ATS scanner to see why recruiters aren&apos;t
                calling you back. Professional insights in seconds.
              </p>
            </div>
          </div>
        )}
